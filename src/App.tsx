...
export default function App() {
  // === НАСТРОЙКИ ===
  const channelName = "Apex — Эволюция Трейдера";
  const subscribersCount = "10 191 подписчика";
  const telegramLink = "https://t.me/+LMD8ZYnckWE5ODhi"; // Диплинка для iOS (сразу открывает приложение Телеграма, минуя браузер)
  const avatarUrl = "https://i.ibb.co/9HBLBpK3/Ujm-EVYOfwl8-Uah-IJ5w-L6l-BGSnsi-UCjyq-Kvvebebff8-M0ie4ylr-F6-IRnp-Mm-Qu2k6say07-SWSUUPZPUDWc-Gkc-Q8u-Ol.jpg"; // Изображение пользователя
